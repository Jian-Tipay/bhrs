      ...
      <div class="card-body">
        <div class="d-flex justify-content-between">
          <div class="card-info">
            ...
            <h4 class="mb-0"><?php echo e(App\Models\User::where('role', 'landlord')->count()); ?></h4>
          </div>
          <div class="card-icon">
      ...
      <div class="card-body">
        <div class="d-flex justify-content-between">
          <div class="card-info">
            ...
            <h4 class="mb-0"><?php echo e(App\Models\User::where('role', 'user')->count()); ?></h4>
          </div>
          <div class="card-icon">
          ...
          <div class="row g-3">
            ...
            <div class="col-md-2">
              ...
              <select class="form-select" name="role">
                ...
                <option value="user" <?php echo e(request('role') === 'user' ? 'selected' : ''); ?>>Tenant</option>
              </select>
            </div>
            <div class="col-md-2">
  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <div>
          <span class="text-muted">Showing <?php echo e($users->firstItem() ?? 0); ?> to <?php echo e($users->lastItem() ?? 0); ?> of <?php echo e($users->total()); ?> users</span>
        </div>
      </div>
      <div class="card-body">
            ...
            <tbody>
              <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    ...
                    <div class="d-flex align-items-center">
                      <div class="avatar avatar-sm me-2">
                        <?php if($user->profile_picture): ?>
                          <img src="<?php echo e(asset($user->profile_picture)); ?>" 
                               alt="<?php echo e($user->first_name ?? $user->name); ?>" 
                               class="rounded-circle"
                               style="width: 38px; height: 38px; object-fit: cover;">
                        <?php else: ?>
                          <span class="avatar-initial rounded-circle bg-label-<?php echo e($user->role === 'landlord' ? 'info' : ($user->role === 'admin' ? 'danger' : 'primary')); ?>">
                      ...
                      <div>
                        <strong><?php echo e($user->first_name ?? $user->name); ?> <?php echo e($user->last_name ?? ''); ?></strong>
                        <?php if($user->student_number): ?>
                          <br><small class="text-muted"><?php echo e($user->student_number); ?></small>
                        <?php endif; ?>
                      </div>
                    </div>
                  </td>
                  ...
                  <td>
                    <?php switch($user->role):
                      ...
                      <?php case ('user'): ?>
                        ...
                        <?php break; ?>
                      <?php default: ?>
                        <span class="badge bg-label-secondary"><?php echo e(ucfirst($user->role)); ?></span>
                    <?php endswitch; ?>
                  </td>
                  <td>
                    <?php if($user->contact_number): ?>
                      <i class='bx bx-phone'></i> <?php echo e($user->contact_number); ?>
                  ...
                  <td>
                    <?php echo e($user->created_at->format('M d, Y')); ?><br>
                  ...
                  <td>
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu">
                        <a class="dropdown-item" href="<?php echo e(route('admin.users.view', $user->id)); ?>">
                        ...
                        <?php if($user->approval_status === 'pending'): ?>
                          ...
                          <a class="dropdown-item text-success" href="javascript:void(0);" onclick="approveUser(<?php echo e($user->id); ?>)">
                            <i class='bx bx-check-circle me-1'></i> Approve
                          </a>
                          <a class="dropdown-item text-warning" href="javascript:void(0);" onclick="showRejectModal(<?php echo e($user->id); ?>, '<?php echo e($user->first_name ?? $user->name); ?>')">
                        ...
                        <?php if($user->id !== Auth::id()): ?>
                          <div class="dropdown-divider"></div>
                          <a class="dropdown-item text-danger" href="javascript:void(0);" onclick="deleteUser(<?php echo e($user->id); ?>)">
        ...
        <div class="mt-4 d-flex justify-content-center">
          <ul class="pagination pagination-sm mb-0 shadow-sm rounded">
            ...
            <?php else: ?>
              <li class="page-item"><a class="page-link" href="<?php echo e($users->previousPageUrl()); ?>" rel="prev">&laquo;</a></li>
            <?php endif; ?>
            ...
            <?php if($users->hasMorePages()): ?>
              <li class="page-item"><a class="page-link" href="<?php echo e($users->nextPageUrl()); ?>" rel="next">&raquo;</a></li>
            <?php else: ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/contentNavbarLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\renzl\Downloads\myprojects\bhrs\resources\views/content/admin/users/index.blade.php ENDPATH**/ ?>